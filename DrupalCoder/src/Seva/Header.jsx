...
import Burger from './Mini-components/Burger';
      ...
      <header>
        ...
        <ConfigProvider
          ...
          <nav className='mobdisplay'>
            <a href='' style={{zIndex: '100000'}}><img src={logo}/></a>

            <Burger menuData={menuData} />
          </nav>
          <nav className='pcdisplay'>
            <a href='' style={{display: 'flex', alignItems: 'center'}}><img src={logo} alt="Логотип"/></a>
            <div className='navigator'>
              <a href=''>ПОДДЕРЖКА DRUPAL</a>
              <DropdownWithArrow 
                items={menuData.find(item => item.key === 'Admin')?.children || []} 
                label="АДМИНИСТРИРОВАНИЕ"
              />
              <a href=''>ПРОДВИЖЕНИЕ</a>
              <a href=''>РЕКЛАМА</a>
              <DropdownWithArrow 
                items={menuData.find(item => item.key === 'About')?.children || []} 
                label="О НАС"
              />
              <a href=''>ПРОЕКТЫ</a>
              <a href=''>КОНТАКТЫ</a>
