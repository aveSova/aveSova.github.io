...
const testimonials = [
  ...
  {
    id: 4,
    logo: "../assets/nashagazeta_ch.png",
...
export default function ReviewsCarousel() {
  ...
  return (
    <section className="reviews">
      ...
      <img src="../assets/Group.png" alt="" className="reviews__quotes"></img>
